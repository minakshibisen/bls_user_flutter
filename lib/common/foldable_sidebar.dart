...
class FoldableSidebarBuilder extends StatelessWidget {
  ...
  const FoldableSidebarBuilder({required Key key, required this.status, required this.width, required this.drawer, required this.screenContents, required this.drawerBackgroundColor}) : super(key: key);
    ...
    return LayoutBuilder(builder: (context,constraints) {
      return TweenAnimationBuilder<double>(
          ...
          builder: (context, data, child) {
            final double drawerWidth = width * data;
